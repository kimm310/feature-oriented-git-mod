...
from git_tool.feature_data.models_and_context.repo_context import get_current_branch, repo_context


def get_commits_for_file(file_name:str, branch_name: Optional[str]= None) -> str:
    """
    ...
    with repo_context() as repo:
        ...
        branch_selector = f"--branches={branch_name}"
